...
_(Note: Azure Document Intelligence requires setting your specific API key and endpoint URL)._
...
_(The server will start using `tsx` in watch mode)_
...
_(This will start the Vite server. Open the provided localhost URL in your browser to view the app)_
...
3. **Verify & Refine with AI:** Use the built-in chat interface to interact with Google Gemini. You can ask it to format data, verify columns, or extract specific information (e.g., _"What are the column headers?"_ or _"Format the totals as currency"_).
