...
## Usage
How to run it or use it: To be determined
...
- **Frontend:** React JS + TailwindCSS (hosted on hosting platform)
- **Backend:** Meteor paired with mongoDB (both hosted on hosting platform)
- **OCR:** Google Vision
- **Testing:** Vitest
- **LLM:** Google Gemini
- **Storage:** MongoDB; with Local in Session for minor storage
