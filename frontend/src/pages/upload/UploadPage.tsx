...
export default function UploadPage() {
        ...
        try {
            const selectedItems = [...selectedPages]
                ...
                .map((item) => ({
                    ...
                    fileName: item.subtitle ? `${item.label} (${item.subtitle})` : item.label
                }));
                ...
                (progress) => {
                    if (progress.type === 'job_progress') {
                        setBatchProgress({
                            ...
                            total: progress.total || selectedItems.length,
                            fileName: progress.fileName || '',
                            status: 'Processing'
                        });
                    } else if (progress.type === 'job_completed') {
                        setBatchProgress({
                            current: progress.index || 1,
                            total: progress.total || selectedItems.length,
                            fileName: progress.fileName || '',
    ...
    const renderNotification = () => {
        if (!uploadError && !uploadSuccess && !retryMessage && !batchProgress) return null;
        return (
            <div className="toast toast-top toast-center z-50 mt-16 flex flex-col gap-2 items-center">
                {uploadError && (
                ...
                {batchProgress && isProcessing && (
                    <div
                        className="alert alert-info p-3 text-sm rounded-xl flex items-center gap-3 shadow-lg max-w-md bg-info/20 border border-info">
                        ...
                        <div className="flex-1">
                            ...
                            <div className="text-[11px] text-base-content/80 truncate">
                ...
                {retryMessage && (
                    <div
                        className="alert alert-warning mb-2 p-3 text-sm rounded-xl flex items-start gap-2 shadow-lg max-w-sm">
                        <svg xmlns="http://www.w3.org/2000/svg" className="mt-0.5 h-4 w-4 shrink-0" viewBox="0 0 20 20"
                             fill="currentColor">
                ...
                {uploadSuccess && (
                    <div className="alert alert-success shadow-lg">
                        ...
                        <div>
                            <h3 className="font-bold">Batch Processing Complete</h3>
                            <div className="text-xs">Redirecting to validation & review...</div>
                        </div>
                    </div>
                )}
            </div>
    ...
    return (
        <div className="bg-base-100 fixed top-[92px] inset-x-0 bottom-0 z-0 flex flex-col">
            ...
            <header
                className="bg-base-100 text-base-content flex h-12 shrink-0 items-center px-6 text-xl font-extrabold border-b border-base-300">
                Preview
            </header>
                ...
                <div className="modal modal-open z-50">
                    <div className="modal-box">
                        ...
                        <p className="py-4">
                            ...
                            page <strong>{replaceConfirm.itemTitle}</strong> with <strong>{replaceConfirm.newFile.name}</strong>?
                        </p>
            ...
            {removeConfirm && (
                <div className="modal modal-open z-50">
                    <div className="modal-box">
                        ...
                        <p className="py-4">
                            Are you sure you want to remove <strong>{removeConfirm.length}</strong> selected page(s)?
            ...
            {bulkReplaceConfirm && (
                <div className="modal modal-open z-50">
                    <div className="modal-box">
                        ...
                        <div className="modal-action">
                            <button className="btn btn-ghost" onClick={() => setBulkReplaceConfirm(null)}>Cancel
                            </button>
            ...
            <div className="flex min-h-0 flex-1">
                ...
                <main className="bg-base-100 flex-1 overflow-y-auto p-5">
                    <div
                        className="grid auto-rows-auto grid-cols-[repeat(auto-fill,minmax(200px,1fr))] content-start gap-[18px]">
